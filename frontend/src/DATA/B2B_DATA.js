...
export const OFFER = [
	// Add comments for each property
	{
		...
		front: {
			...
			dates: [``],
			location: ``,
			desc: `Łagodna praktyka ruchu, która\u00A0odciąża kręgosłup, redukuje napięcia wynikające z\u00A0siedzącego trybu pracy i\u00A0wzmacnia mięśnie. Dzięki niej pracownicy czują się\u00A0bardziej zrelaksowani, zdrowi i\u00A0pełni energii na\u00A0co\u00A0dzień`,
			btnsContent: [],
		},
	...
	},
	{
		...
		front: {
			...
			dates: [``],
			location: ``,
			desc: `Trening uważności, który\u00A0uczy, jak świadomie zarządzać stresem i\u00A0emocjami. Pomaga pracownikom działać efektywniej, poprawia koncentrację i\u00A0wspiera odporność psychiczną`,
			btnsContent: [],
		},
	...
	},
	{
		...
		front: {
			...
			dates: [],
			location: ``,
			desc: `Proste metody oddechowe i\u00A0wizualizacyjne, które\u00A0redukują napięcie i\u00A0wspierają regenerację. Pracownicy szybciej się\u00A0odprężają i\u00A0lepiej radzą sobie w\u00A0trudnych sytuacjach.`,
			btnsContent: [],
		},
