		...
		children: [
			...
			// {path: 'grafik/book/:id', element: <SchedulePage />},
			{
				...
				children: [
					...
					{path: 'show-all-users/:id', element: <AdminPage modifier='user' />},
					{path: 'show-all-customers/:id', element: <AdminPage modifier='customer' />},
					{path: 'show-all-products/:id', element: <AdminPage modifier='product' />},
					{path: 'show-all-schedules/:id', element: <AdminPage modifier='product' />},
					{path: 'show-all-bookings/:id', element: <AdminPage modifier='booking' />},
					{
