function DetailsCustomerReviews({reviews}) {
				...
				{feedbackArray.map((feedback, index) => {
					...
					return (
						<li
							...
							<div className='schedules__record-content'>{feedback.product}</div>
							<div className='schedules__record-content'>{feedback.schedule}</div>
