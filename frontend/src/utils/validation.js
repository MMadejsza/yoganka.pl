...
export const firstNameValidations = [
	...
	},
	{
		...
		rule: (value) => /^[A-Za-zÀ-ÿĄąĆćĘęŁłŃńÓóŚśŹźŻżА-Яа-яЁёІіЇїЄє\s'-]+$/.test(value),
	...
	},
	{
		...
		message: '*podanie inicjałów może skutkować późniejszym usunięciem zgłoszenia',
	},
];
//! LAST NAME RULESET
export const lastNameValidations = [
	...
	{
		rule: (value) => /^[A-Za-zÀ-ÿĄąĆćĘęŁłŃńÓóŚśŹźŻżА-Яа-яЁёІіЇїЄє\s'-]+$/.test(value),
		message: 'Nazwisko może zawierać tylko litery, spacje, apostrofy i myślniki',
	},
	{
		rule: (value) => !containsProfanity(value),
		message: 'Generalna walidacja',
